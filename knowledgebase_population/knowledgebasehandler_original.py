...
from knowledgebase_population import linguisticpopulator, verboceanpopulator
    ...
    for case_name in case_names:
        ...
        if os.path.isfile(file_path):
            ...
            for observation in observations:
                kb.add_observation(observation[0], observation[1], observation[2])
...
def populate_verbocean():
    kb = KnowledgeBase()
    verboceanpopulator.populate(kb, count_per_record=1000)
    print("loaded kb with", kb.get_record_numbers(), "records")
    return kb
